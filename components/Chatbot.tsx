...
const Chatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: '0', role: 'model', text: "Soy el gemelo digital de Alfredo. Soy más inteligente, más rápido y un poco menos humilde. Pregúntame por qué nos necesitas.", timestamp: Date.now() }
  ]);
          ...
          >
            ...
            <div className="bg-stone-900 text-white p-4 flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="font-serif italic font-bold">I.A. Alfredo</span>
              </div>
            ...
            <div className="p-3 bg-white border-t border-stone-100 flex gap-2">
              <input
                ...
                placeholder="Pregúntame algo estúpido..."
